...
public class SearchClass {
    ...
    Boolean existenceOfProductionCompany(String proCompany)
    {
      ...
      static List<Movie> search_recent_movie(String production_company)
    {
        ...
        {
            Movie m = MovieList.movielist.get(i);
            if(m.getProduction_company().equalsIgnoreCase(production_company))
            {
    ...
    static List<Movie> search_max_revenue(String production_company)
    {
    ...
    static long total_profit_company(String production_company)
    {
        long totalpro = 0;
        for(int i = 0; i<MovieList.movielist.size(); i++)
        {
    ...
    {
        Set<String> production_company_list = new HashSet<>();
        System.out.println("sizeof movie list inside func: " + MovieList.movielist.size());
        for (int i = 0; i < MovieList.movielist.size(); i++) {
            Movie m = MovieList.movielist.get(i);
            System.out.println(m.getProduction_company());
            production_company_list.add(m.getProduction_company());
        }
        for (String comp : production_company_list) System.out.println(comp);
