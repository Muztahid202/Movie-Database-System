...
public class MaxRevenueMovie implements Initializable {
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        tableView.setItems(FXCollections.observableList(SearchClass.search_max_revenue(MovieClient.companyMovieList)));
