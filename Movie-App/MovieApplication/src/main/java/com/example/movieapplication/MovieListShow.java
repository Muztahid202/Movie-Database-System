...
public class MovieListShow implements Initializable {
    @FXML
    private Stage stage;
    private Scene scene;
    private Parent root;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle)
    {
        ...
        MovieApplication.controller = this;
        ...
        Table.setItems(FXCollections.observableList(MovieClient.companyMovieList));
    }
